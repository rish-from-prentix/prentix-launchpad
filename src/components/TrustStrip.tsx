  ...
  return (
    <section className="py-20">
      <div className="container flex justify-center">
        <div className="flex items-center justify-center gap-6 px-12 py-6 bg-white rounded-3xl shadow-[0_4px_24px_rgba(0,0,0,0.12),0_1px_4px_rgba(0,0,0,0.06)] max-w-[700px] w-full mx-auto">
